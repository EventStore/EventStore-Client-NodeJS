...
export interface ReadStreamFastOptions extends BaseOptions {
  /**
...
declare module "../Client" {
  interface Client {
     ...
     */
    readStreamFast<KnownEventType extends EventType = EventType>(
      streamName: string,
      options?: ReadStreamFastOptions,
      readableOptions?: ReadableOptions
    ): Promise<AsyncIterableIterator<ResolvedEvent<KnownEventType>>>;
  }
}

Client.prototype.readStreamFast = async function <
...
>(
  ...
  streamName: string,
  {
    ...
    direction = FORWARDS,
    ...baseOptions
  }: ReadStreamFastOptions = {}
): Promise<AsyncIterableIterator<ResolvedEvent<KnownEventType>>> {
  const options: bridge.ReadStreamOptions = {
