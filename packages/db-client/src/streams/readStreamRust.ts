...
export interface ReadStreamRustOptions extends BaseOptions {
  /**
...
declare module "../Client" {
  interface Client {
     ...
     */
    readStreamRust<KnownEventType extends EventType = EventType>(
      streamName: string,
      options?: ReadStreamRustOptions,
      readableOptions?: ReadableOptions
    ): Promise<AsyncIterableIterator<ResolvedEvent<KnownEventType>>>;
  }
}

Client.prototype.readStreamRust = async function <
