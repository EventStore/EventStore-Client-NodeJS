  ...
  public up = async (): Promise<void> => {
    ...
    if (!this.insecure) {
      this.certificates = {
        ...
        users: {
          admin: {
            certPath: await readFile(this.certPath.admin.certPath),
            certKeyPath: await readFile(this.certPath.admin.certKeyPath),
          },
          invalid: {
            certPath: await readFile(this.certPath.invalid.certPath),
            certKeyPath: await readFile(this.certPath.invalid.certKeyPath),
          },
        },
      };
    }
