...
export class StartScavengeReq extends jspb.Message {
  ...
  setOptions(value?: StartScavengeReq.Options): void;
...
export namespace StartScavengeReq {
  ...
  export class Options extends jspb.Message {
    ...
    setStartFromChunk(value: number): void;
...
export class StopScavengeReq extends jspb.Message {
  ...
  setOptions(value?: StopScavengeReq.Options): void;
...
export namespace StopScavengeReq {
  ...
  export class Options extends jspb.Message {
    ...
    setScavengeId(value: string): void;
...
export class ScavengeResp extends jspb.Message {
  ...
  getScavengeResult(): ScavengeResp.ScavengeResultMap[keyof ScavengeResp.ScavengeResultMap];
  setScavengeResult(value: ScavengeResp.ScavengeResultMap[keyof ScavengeResp.ScavengeResultMap]): void;
...
export namespace ScavengeResp {
  export type AsObject = {
    scavengeId: string,
    scavengeResult: ScavengeResp.ScavengeResultMap[keyof ScavengeResp.ScavengeResultMap],
  }

  export interface ScavengeResultMap {
    STARTED: 0;
    INPROGRESS: 1;
    STOPPED: 2;
  }

  export const ScavengeResult: ScavengeResultMap;
}
