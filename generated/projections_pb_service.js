...
var Projections = (function () {
  ...
  Projections.serviceName = "event_store.client.projections.Projections";
  return Projections;
}());
...
ProjectionsClient.prototype.restartSubsystem = function restartSubsystem(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Projections.RestartSubsystem, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
